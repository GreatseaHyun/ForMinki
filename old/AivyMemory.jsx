...
const MOCK_SESSIONS = [
  {
    ...
    date: "Today, 14:30",
    ago: "2h ago",
    preview: "Budget confirmed at 30M KRW. Report deadline: next Wednesday.",
  ...
  },
  {
    id: 2,
    type: "navigation",
    title: "Sogang Univ → Gangnam Station",
    date: "Today, 11:20",
    ago: "5h ago",
    preview: "1.2km walked in 16 min. Arrived via Sinchon Station route.",
    tags: ["walk", "arrived"],
    icon: "🗺",
    color: "#E8EEF4",
    accentColor: "#2E5E8E",
  },
  {
    id: 3,
    type: "ocr",
    title: "Restaurant Menu — Ichiran Ramen",
    date: "Yesterday, 19:45",
    ago: "1d ago",
    preview: "Tonkotsu Ramen ¥980, Extra noodles ¥150. Recommended: Original flavor.",
    tags: ["menu", "price"],
    icon: "📸",
    color: "#FFF8E1",
    accentColor: "#F9A825",
  },
  {
    id: 4,
    type: "exercise",
    title: "Evening Run — Han River",
    date: "Yesterday, 18:00",
    ago: "1d ago",
    preview: "5.1km in 31:42. Avg pace 6:11/km. Cadence stable at 172 SPM.",
    tags: ["running", "5km"],
    icon: "🏃",
    color: "#E8F5E9",
    accentColor: "#2E8B57",
  },
  {
    id: 5,
    type: "translation",
    title: "Conversation at Tokyo Station",
    date: "Mar 5, 15:30",
    ago: "4d ago",
    preview: "8 turns. Asked for directions to Shinjuku platform. JA↔KO.",
    tags: ["japanese", "directions"],
    icon: "🌐",
    color: "#E3F2FD",
    accentColor: "#3A7BBF",
  },
  {
    ...
    date: "Mar 4, 10:00",
    ago: "5d ago",
    preview: "UI mockups approved. Park to finalize icons by Friday.",
    tags: ["design", "action-item"],
    icon: "📝",
    color: "#F3E5F5",
    accentColor: "#7B1FA2",
  },
  {
    id: 7,
    type: "ocr",
    title: "Medicine Label — Tylenol",
    date: "Mar 3, 09:15",
    ago: "6d ago",
    preview: "Dosage: 1-2 tablets every 6 hours. Do not exceed 8 tablets/day.",
    tags: ["medicine", "dosage"],
    icon: "📸",
    color: "#FFF8E1",
    accentColor: "#F9A825",
  },
...
function EntityBadge({ type, value }) {
  const colors = {
    MONEY: { bg: "#FFF3E0", text: "#E67E22" },
    PERSON: { bg: "#F3E5F5", text: "#7B1FA2" },
    TIME: { bg: "#E3F2FD", text: "#2E5E8E" },
    PLACE: { bg: "#E8F5E9", text: "#2E8B57" },
    DATE: { bg: "#E8F5E9", text: "#2E8B57" },
    ACTION: { bg: "#FFEBEE", text: "#CC3333" },
  };
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 4 }}>
          <div style={{ fontSize: 14, fontWeight: 700, color: "#333", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: 1, marginRight: 8 }}>
            {session.title}
          </div>
...
// ===== Main =====
export default function AivyMemory() {
    ...
    >
      ...
      <div style={{ padding: "20px 24px 8px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
          <div style={{ cursor: "pointer" }}><BackIcon /></div>
          <div>
      ...
      <div style={{ padding: "8px 20px 4px" }}>
        <div
          style={{
            ...
            border: isSearching ? "1.5px solid #E67E22" : "1.5px solid transparent",
        ...
        >
          ...
          <input
            type="text"
            placeholder="Ask anything... (e.g. 예산 얼마였지?)"
            value={searchText}
          ...
          />
          {searchText && (
            <div onClick={clearSearch} style={{ cursor: "pointer", fontSize: 18, color: "#CCC", lineHeight: 1 }}>
              ×
            </div>
          )}
          <div
            ...
            style={{
              padding: "6px 14px",
              borderRadius: 8,
              backgroundColor: searchText.trim() ? "#1B3A5C" : "#F0F0F0",
      ...
      {!askResult && !isSearching && (
        <div style={{ padding: "10px 20px 0" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
            <ClockIcon />
            <span style={{ fontSize: 11, color: "#CCC" }}>Recent</span>
          </div>
        ...
        <div style={{ padding: "14px 20px", animation: "fadeUp 0.3s ease" }}>
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 12 }}>
              <SparkleIcon />
              <span style={{ fontSize: 12, fontWeight: 600, color: "#E67E22" }}>Ask AI</span>
            </div>
            ...
            {/* Answer */}
            <div style={{ fontSize: 16, fontWeight: 600, color: "#1B3A5C", lineHeight: 1.6, marginBottom: 16 }}>
              {askResult.answer}
            </div>

            {/* Entities */}
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 14 }}>
              {askResult.entities.map((e, i) => (
                <EntityBadge key={i} type={e.type} value={e.value} />
              ))}
            </div>
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 10, color: "#BBB" }}>
                  {askResult.source.speaker} · {askResult.source.time}
                </div>
              </div>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#CCC" strokeWidth="2" strokeLinecap="round">
      ...
      <div style={{ padding: "4px 20px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
          <span style={{ fontSize: 11, fontWeight: 600, color: "#999", letterSpacing: 0.5, textTransform: "uppercase" }}>
            Session History
          </span>
        ...
        {filteredSessions.length === 0 && (
          <div style={{ textAlign: "center", padding: "40px 0", color: "#DDD", fontSize: 14 }}>
            No sessions found
          </div>
        )}
      </div>
